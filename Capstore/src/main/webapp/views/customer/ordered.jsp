...
<br><br><br><br>
				...
				<c:forEach items="${products}" var="festival" varStatus="i">
					<tr>
						<td><c:out value="${festival.prodId}" /></td>
						<td><c:out value="${festival.name}" /></td>
						<td><c:out value="${festival.price}" /></td>
						<td><button type="button" class="btn btn-success" onclick="window.location.href='return?id=${festival.prodId}'">Return</button> </td>
					</tr>
				</c:forEach>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url(../resources/img/bg-img/bg-2.jpg);">
                        <div class="catagory-content">
                            <a href="getCategory/${category}">${category}</a>
                        </div>
                    </div>
                </div>
       <!--  Single Category -->
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <c:forEach items="${category}" var="product">
                        ...
                        <h2>Brajesh</h2><h2>Brajesh</h2><h2>Brajesh</h2><h2>Brajesh</h2><h2>Brajesh</h2><h2>Brajesh</h2><h2>Brajesh</h2><h2>Brajesh</h2><h2>Brajesh</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <c:forEach items="${category}" var="productlist">
                       ...
                       <!-- Single Product -->
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <a href="getProduct/${prod.prod_id}"><img class="hover-img" src="../resources/img/product-img/iphone-x.png" alt=""></a>
                                <!-- Favourite -->
                            ...
                            <div class="product-description">
                                <span>${prod.name} </span>
                                <a href="getProduct/${prod.prod_id}">
                                    <h6>${prod.sizes} </h6>
                                </a>
                                ...
                                <div class="hover-content">
                                    ...
                                    <div class="add-to-cart-btn">
                                        <a href="addToCart?productId=${prod.prod_id}" class="btn essence-btn">Add to Cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
