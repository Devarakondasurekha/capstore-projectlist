...
<div class="checkout_area section-padding-80">
		...
		<div><br></div>
            <div class="row">
				<div class="col-md-6">
			<sf:form name="cust_register" id="cust_register" class="form-horizontal" onsubmit="return checkForm(this);" action="AdminMerchantSuccess" method="POST"  modelAttribute="address">
