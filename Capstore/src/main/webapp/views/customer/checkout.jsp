...
<body>
    ...
    <div class="checkout_area section-padding-80">
		...
		<input type="radio" name="modeOfPurchase" onclick="showAccountDetails()" id="credit" value="Credit"/><b>Credit</b></br></br>
		<div   id="showAccount">
		<div>
			Card Number: <input  type="text"></br></br>
			CVV Number: <input  type="text"></br></br>	
			
		</div>
	</div>
		<input type="radio" name="modeOfPurchase" onclick="showAccountDetails()" id="debit" value="Debit"/><b>Debit</b></br></br>
		<div   id="showAccount1">
		<div>
			Card Number: <input  type="text"></br></br>
		...
		<input type="radio" name="modeOfPurchase" onclick="showAccountDetails()" id="NetBanking" value="NetBanking"/><b>Net Banking</b></br></br>
		<div   id="showNetAccount">
		<div>
			Account Number: <input  type="text"><br><br>
			User Name: <input  type="text"><br><br>
			Password: <input  type="text"><br><br>	
		</div>
	</div>
		<input type="radio" name="modeOfPurchase" onclick="showAccountDetails()" id="CashOnDelivery" value="CashOnDelivery"/><b>Cash on Delivery</b></br></br>
		
	</div>

                        <a href="Invoice?totalPrice=${totalPrice}" class="btn essence-btn">Place Order</a>
                    </div>
                </div>
            </div>
        </div>
