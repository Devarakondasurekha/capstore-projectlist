        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <button class="btn btn-dark d-inline-block d-lg-none ml-auto" type="button" data-toggle="toggle" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
           ...
           <form action="AdminDeleteMerchant">
             <table id="product" class="table table-striped table-bordered" style="width:100%">
				...
				<tbody>
				<a:forEach items="${merchants}" var="merchant">
				<tr>
				<td>${merchant.merchantMobileNo}</td>
				<td>${merchant.merchantName}</td>
				<td><button type="button" class="btn btn-danger" onclick="javascript:window.location.href='AdminRemoveMerchant?id=${merchant.merchantMobileNo}'" >Remove</button></td>
				</tr>
