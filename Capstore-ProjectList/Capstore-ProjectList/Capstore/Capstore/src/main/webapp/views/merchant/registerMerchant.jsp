...
<div class="checkout_area section-padding-80">
		...
		<div><br></div>
            <div class="row">
				<div class="col-md-6">
			<sf:form name="merchant_register" id="merchant_register" class="form-horizontal" onsubmit="return checkForm(this);" action="merchantaddresspage" method="POST"  modelAttribute="merchant">
