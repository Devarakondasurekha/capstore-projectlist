        ...
        <div id="content">
           ...
           <form action="admin_remove_products">
             <table id="product" class="table table-striped table-bordered" style="width:100%">
				...
				<tbody>
				<a:forEach items="${abc}" var="prod">
				<tr>
				<td>${prod.prodId}</td>
				<td>${prod.name}</td>
				<td><button type="button" class="btn btn-danger" onclick="javascript:window.location.href='adminDeleteProduct?id=${prod.prodId}'" >Remove</button></td>
				</tr>
