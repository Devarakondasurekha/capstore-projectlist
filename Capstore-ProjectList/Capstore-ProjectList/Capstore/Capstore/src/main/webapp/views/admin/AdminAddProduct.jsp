...
<body>
            ...
            <ul class="list-unstyled components">
               <li align="center"> <h4><b>ADMIN</b></h4></li>
				...
				<li>
                    ...
                    <li>
					<a href="admin_add_products">Add Products</a>
				</li>
				<li>
	...
	<tr>
	 <td>Product Size  </td> 
	 <td><input type="text" name="sizes" placeholder="Product Size" required /></td>
	</tr>
	<!-- <tr>
	 <td>Product Initial Quantity  </td> 
	 <td><input type="number" name="initialQuantity" placeholder="Product Quantity" required /></td>
	</tr> -->
	<tr>
 <td>Product Available Quantity  </td> 
	 <td><input type="number" name="availableQuantity" placeholder="Available Quantity"  required/></td>
	</tr>
	  <tr>
	  <td>Product Price</td>
	   <td><input type="number" name="price" placeholder="Product Price" required/></td>
       </tr>
	   <tr>
      <td>Product Discount</td>
      <td><input type="number" name="prodDiscount" placeholder="Discount Offered" required /></td>
       </tr>
	   <tr>
	   <td>Product Category </td>
	    <td><input type="text" name="prodCategory" placeholder="Enter Category" required/></td>
	    </tr>
	       <tr>
	    <td>Product Image url </td>
	    <td><input type="text" name="url" placeholder="Image URL" required/></td>
	    </tr>
