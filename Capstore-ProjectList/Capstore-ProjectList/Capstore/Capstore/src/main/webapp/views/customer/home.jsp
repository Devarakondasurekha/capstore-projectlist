...
<%-- 	<%=(String) request.getSession().getAttribute("sessionid")%>
							...
							<li><a href="#">Categories</a>
								<ul class="dropdown">
									<c:forEach items="${map.keySet()}" var="categoryMap">
										...
										<li><a href="getCategory/${categoryMap}">${categoryMap}</a></li>
									</c:forEach>
								</ul></li>
 ...
 -->
				...
				<div class="cart-area">
					<a href="profile" id="essenceCartBtn"><img
								...
								<c:forEach items="${productList.getValue()}" var="product">
									...
									<div class="single-product-wrapper">
										...
										<div class="product-img">
											...
											<!-- Hover Thumb -->
											<a href="getProduct/${product.prodId}"><img
												class="hover-img" src=""></a>
											<!-- Favourite -->
										...
										<div class="product-description">
											<span>${product.name} </span> <a
												href="getProduct/${product.prodId}">
												<h6>${product.sizes}</h6>
											</a>
											...
											<div class="hover-content">
												...
												<div class="add-to-cart-btn">
													<a href="addToCart?productId=${product.prodId}"
