...
<div class="checkout_area section-padding-80">
		...
		<div><br></div>
            <div class="row">
				<div class="col-md-6">
			<sf:form name="merchant_register" id="merchant_register" class="form-horizontal" onsubmit="return checkForm(this);" action="AdminMerchantAddress" method="POST"  modelAttribute="merchant">
              <div class="form-group">
                  <label for="merchantMobileNo" class="col-sm-6 control-label">Mobile Number</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="merchantMobileNo" pattern="^([0|\+[0-9]{1,5})?([7-9][0-9]{9})$" placeholder="Enter Your Mobile Number" required>
                  </div>
                </div>
              <div class="box-body">
			  <div class="form-group">
   ...
   <div class="form-group">
                  <label for="merchantType" class="col-sm-6 control-label">Merchant Type</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="merchantType"  placeholder="Merchant Type Can be Normal or Third Party" required>
                  </div>
                </div>
