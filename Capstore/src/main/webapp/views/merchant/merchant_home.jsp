...
<body>
	...
	<div class="wrapper">
		...
		<ul class="list-unstyled components">
			<li align="center"><link rel="icon" href="../resources/img/merchant.ico">
				<h4>Merchant</h4></li>
		...
		<div id="content">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="nav navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="getLogout">Sign
								Out</a></li>
					</ul>
				</div>
			</div>
           ...
           <div >
            ...
            <marquee><h1 >Welcome Merchant</h1></marquee>
           </div>
